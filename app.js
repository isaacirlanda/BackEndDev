...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('shop.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('shop.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('shop.xml', function(err, result) {
      ...
      result.shop.items[obj.sec_n].device.push({'company': obj.company, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('shop.xml', function(err, result) {
      ...
      delete result.shop.items[obj.items].device[obj.device];
